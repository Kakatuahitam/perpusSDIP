...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
    ...
    $html_str .= '<html xmlns="http://www.w3.org/1999/xhtml"><head><title>Document Label Print Result Develop</title>'."\n";
    ...
    foreach ($chunked_label_arrays as $label_data) {
        ...
        foreach ($label_data as $label) {
            ...
            // change color here #kakatuahitam label warna

            // 000 -> hijau - green (black)
            // 100 -> biru - blue (white)
            // 200 -> kuning - yellow (black)
            // 300 -> merah - red (white)
            // 400 -> hijau muda - lightgreen (black)
            // 500 -> ungu muda - lightpurple (black)
            // 600 -> merah muda - lightred (black)
            // 700 -> orange - orange (black)
            // 800 -> biru - lightblue (black)
            // 900 -> merah jambu - pink (black)
            // referensi -> krem - beige (black)
            // audiovisual -> orange - orange (black)
